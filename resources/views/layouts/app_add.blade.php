...
<html lang="en">
    ...
    <header class="header_area" style="background:black;">
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            ...
                            @else
								...
								<li class="nav-item active"><a class="nav-link" href="/article"><i class="fa fa-plus" aria-hidden="true"> Agregar</i></a></li> 
        ...
        <section class="banner_area">
            <div class="box_1620">
				<div class="banner_inner d-flex align-items-center" style="background: url({{Cloudder::show('/Users_multi/'.$user->imagen_banner, array("width"=>1620, "height"=>650, "crop"=>"fill"))}}) no-repeat scroll center;" data-stellar-background-ratio="0.5">
					<div class="container">
    ...
    <footer class="footer_area">
        ...
        function handle(e){
            if(e.keyCode === 13){
               ...
               <script  src="{{ asset("../js/preview_fotos.js") }}"></script>
        <script
